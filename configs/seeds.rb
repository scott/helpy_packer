...
topic.posts.create(
  ...
  running the upgrade script supplied with your Digital Ocean one click droplet.

  First, head over to https://helpy.io/on-premise and complete a purchase of the license.
  Once you have received the license code, SSH into your droplet and execute the upgrade script
